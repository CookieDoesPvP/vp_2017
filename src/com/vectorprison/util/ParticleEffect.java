...
{
  EXPLOSION_NORMAL("explode", 0, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }),  EXPLOSION_LARGE("largeexplode", 1, -1, new ParticleProperty[0]),  EXPLOSION_HUGE(
  ...
  static
  {
    ...
    ID_MAP = new HashMap();
    ParticleEffect[] arrayOfParticleEffects;
    int j = (arrayOfParticleEffects = values()).length;
    for (int i = 0; i < j; i++)
    {
      ParticleEffect effect = arrayOfParticleEffects[i];
      ...
      try
      {
        ...
        else
        {
          ...
          if (this.data != null)
          {
            ...
            ReflectionUtils.setValue(this.packet, true, "k", new int[] {
              ((Integer)(this.effect == ParticleEffect.ITEM_CRACK ? packetData : Integer.valueOf(packetData[0] | packetData[1] << 12))).intValue() });
          }
        }
...
public void display(Location location1, int i, int j, int k, int l, int m) {
